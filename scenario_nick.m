...
% Generated on: 30-Mar-2021 23:26:12
...
vehicle(scenario, ...
    ...
    'Width', 5, ...
    'Height', 10, ...
    'Position', [-75.2066666666667 18.42 0], ...
    'Yaw', -95, ...
    'PlotColor', [255 0 255] / 255, ...
    'Name', 'small building15');

vehicle(scenario, ...
    'ClassID', 1, ...
    'Position', [-115.06 139.03 0], ...
    'Yaw', 34, ...
    'Mesh', driving.scenario.carMesh, ...
...
vehicle(scenario, ...
    'ClassID', 1, ...
    'Position', [-128.256666666667 126.55 0], ...
    'Yaw', 44, ...
    'Mesh', driving.scenario.carMesh, ...
    'PlotColor', [0.929 0.694 0.125], ...
    'Name', 'Car4');
...
vehicle(scenario, ...
    'ClassID', 1, ...
    'Position', [-95.8833333333333 152.02 0], ...
    'Yaw', 30, ...
    'Mesh', driving.scenario.carMesh, ...
    'PlotColor', [0.929 0.694 0.125], ...
    'Name', 'Car5');
...
vehicle(scenario, ...
    'ClassID', 1, ...
    'Position', [-10.8966666666667 112.8 0], ...
    'Yaw', -150, ...
    'Mesh', driving.scenario.carMesh, ...
    'PlotColor', [0.929 0.694 0.125], ...
    'Name', 'Car7');
